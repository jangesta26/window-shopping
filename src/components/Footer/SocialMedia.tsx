...
const SocialMedia = () => {
  return (
    <div className="mt-6.5">
        <h4 className="mb-3.5 font-medium text-muted dark:text-white">
        Follow us
        </h4>
        <ul className={`${style.icon_container} list-none`}>
            <li className={`${style.icon_content}`}>
                <Link href="https://www.spotify.com/" aria-label="Spotify" data-social="spotify">
            ...
            <li className={`${style.icon_content}`}>
                <Link href="https://www.pinterest.com/" aria-label="Pinterest" data-social="pinterest">
                <div className={`${style.filled}`} />
                ...
                <div className={`${style.tooltip}`}>@pinterest</div>
            </li>
            <li className={`${style.icon_content}`}>
                <Link href="https://dribbble.com/" aria-label="Dribbble" data-social="dribbble">
                <div className={`${style.filled}`} />
                <svg version="1.1" viewBox="0 0 100 100">
                ...
                <div className={`${style.tooltip}`}>@dribbble</div>
            </li>
            <li className={`${style.icon_content}`}>
                <Link href="https://telegram.org/" aria-label="Telegram" data-social="telegram">
                <div className={`${style.filled}`} />
                <svg version="1.1" viewBox="0 0 100 100">
